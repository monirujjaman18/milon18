...
?>
    ...
    <div class="container" style="margin-top:70px;">
            ...
            <div class="col-md-4">
                ...
                <p>
                    Blood Bank &amp; <br>Shariatpur, Dhaka <br>
					Shariatpur Polytechnic Institute <br>
					Nilphamari<br>
					Nilphamari ,Rangpur <br>
                    ML_Monirujjaman ,Student , Computer Technology,Shariatpur Polytechnic Institute
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: 01755273918</p>
